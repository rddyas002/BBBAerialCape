...
#define MPU9150_LSB2DEGREES			(1/(16.4))
#define MPU9150_LSB2GS				(1/(16.384))
#define CALIB_ITERATION 			1000
...
public:
	...
	void autoSample(int threadPriority, int rate);
	void stopAutoSample(void);
...
protected:
    accelerometer_struct accelerometer;
    magnetometer_struct magnetometer;
